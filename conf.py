...
_C.SETTING = "continual" # ['reset_each_shift', 'continual', 'gradual', 'mixed_domains']
...
### ADDED ###
# Based on your previous error, this is where the config expects the CLIP model name.
...
### ADDED ###
# ----------------------------- CLIP Reward TTA options ----------------------- #
_C.CLIP_REWARD = CfgNode()
_C.CLIP_REWARD.LAMBDA_ENTROPY = 0.1 # Weight for the entropy term in the hybrid loss
...
def assert_and_infer_cfg():
    ...
    ### ADDED ###
    # Add your new method name to this list
    assert _C.MODEL.ADAPTATION in ["source", "norm", "tent", "clip_reward"]
